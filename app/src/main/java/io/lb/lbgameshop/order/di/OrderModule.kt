...
import io.lb.lbgameshop.order.domain.use_cases.AddOrderItem
...
import io.lb.lbgameshop.order.domain.use_cases.ResetUnfinishedOrder
...
object OrderModule {
    ...
    fun providesTaskUseCases(repository: OrderRepository) =
        OrderUseCases(
            addOrderItem = AddOrderItem(repository),
            ...
            resetUnfinishedOrder = ResetUnfinishedOrder(repository),
        )
}
